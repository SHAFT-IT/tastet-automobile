...
function add_car_classifieds_meta_boxes() {
	add_meta_box( 'jpro_car_details', __( 'Car Details', 'jprocars' ), 'jpro_car_details', 'car-classifieds', 'normal', 'high' ); // Car details metabox
	add_meta_box( 'jpro_car_photos', __( 'Car Photos', 'jprocars' ), 'jpro_car_photos', 'car-classifieds', 'side', 'high' ); // Car photos metabox
}
/**
 * Get Meta Value
 *
