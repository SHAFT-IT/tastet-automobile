...
function jpro_enqueue_uploader_scripts() {
	...
	if( is_admin() || isset( $_GET['jp'] ) && $_GET['jp'] == 'add-new-classified' || isset( $_GET['jp'] ) && $_GET['jp'] == 'edit-classified' || isset( $_POST['add-new-classified'] ) ) {
		wp_enqueue_script('plupload-all');
 
		wp_register_script('media-uploader', JPRO_CAR_URI . 'assets/js/media-uploader.js', array('jquery'));
...
if( isset( $_GET['jp'] ) && $_GET['jp'] == 'add-new-classified' || isset( $_GET['jp'] ) && $_GET['jp'] == 'edit-classified' || isset( $_POST['add-new-classified'] ) ) {
