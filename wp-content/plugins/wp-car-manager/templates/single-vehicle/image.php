...
<div class="wpcm-images">
	...
	if ( has_post_thumbnail( $vehicle->get_id() ) ) {
		...
		$image_html = sprintf( '<a href="%s" itemprop="image" class="wpcm-main-image zoom" title="%s" data-rel="prettyPhoto%s" target="_blank">%s</a>', $image_link, $image_caption, $gallery, $image ); // use itemprop="image"
