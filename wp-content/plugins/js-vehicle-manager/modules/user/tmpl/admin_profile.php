            ...
            if(JSVEHICLEMANAGERincluder::getObjectClass('user')->isSellerCheck($row->id)){ ?>
                <div class="jsvm_user-stats-top">
                    ...
                    <div class="jsvm_box">
                        ...
                        <div class="jsvm_text">
                            <div class="jsvm_bold-text"><?php echo jsvehiclemanager::$_data['featuredvehicles']; ?></div>
                            <div class="jsvm_nonbold-text"><?php echo __('Featured vehicles', 'js-vehicle-manager'); ?></div>   
                        </div>
                    </div>
                    <div class="jsvm_box">
