...
function initMap( isPluginCall = false ){
...
function sendToSeller(isPluginCall = 0){
    ...
    jQuery.post(common.ajaxurl, { action: "jsvehiclemanager_ajax" , jsvmme: "vehicle" ,task: "sendToSeller" ,name: sname ,email: semail ,message: message ,sellerid: sellerid ,captcha_responce: captcharesponce } , function (data) {
        if (data) {
