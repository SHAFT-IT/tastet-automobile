...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <span class="jsvm_js-admin-title">
        <a href="<?php echo admin_url('admin.php?page=jsvm_modelyears'); ?>"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/back-icon.png" /></a>
        <?php $msg = isset(jsvehiclemanager::$_data[0]) ? __('Edit', 'js-vehicle-manager') : __('Add New','js-vehicle-manager'); ?>
        <?php echo $msg . ' ' . __('Model years', 'js-vehicle-manager'); ?>
    </span>
    <div class="jsvehiclemanager-form-wrap">
        <form id="jsvehiclemanager-form" method="post" action="<?php echo admin_url("admin.php?page=jsvm_modelyears&task=savemodelyear"); ?>">
            ...
            <?php echo JSVEHICLEMANAGERformfield::hidden('jsvehiclemanager_alias', isset(jsvehiclemanager::$_data[0]->alias) ? jsvehiclemanager::$_data[0]->alias : ''); ?>
            ...
            <div class="jsvm_js-submit-container">
                <div class="jsvm_js-button-container">
                    <a id="jsvm_form-cancel-button" href="<?php echo admin_url('admin.php?page=jsvm_modelyears'); ?>" ><?php echo __('Cancel', 'js-vehicle-manager'); ?></a>
                    <?php echo JSVEHICLEMANAGERformfield::submitbutton('save', __('Save','js-vehicle-manager') .' '. __('Model years', 'js-vehicle-manager'), array('class' => 'button')); ?>
                </div>
            </div>
        </form>
    </div>
