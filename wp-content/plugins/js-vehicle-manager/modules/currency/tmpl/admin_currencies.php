...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <div id="jsvehiclemanageradmin-data">
        ...
        <span class="jsvm_js-admin-title">
            ...
            <?php JSVEHICLEMANAGERincluder::getClassesInclude('jsvehiclemanageradminsidemenu'); ?>
            <a class="jsvm_js-button-link button" href="<?php echo admin_url('admin.php?page=jsvm_currency&jsvmlt=formcurrency'); ?>"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add New','js-vehicle-manager') .' '. __('Currency','js-vehicle-manager'); ?></a>
        </span>
        ...
        <form class="jsvm_js-filter-form" name="jsvehiclemanagerform" id="jsvehiclemanagerform" method="post" action="<?php echo admin_url("admin.php?page=jsvm_currency"); ?>">
        ...
        if (!empty(jsvehiclemanager::$_data[0])) {
            ?>
            <form id="jsvehiclemanager-list-form" method="post" action="<?php echo admin_url("admin.php?page=jsvm_currency"); ?>">
                        ...
                        for ($i = 0, $n = count(jsvehiclemanager::$_data[0]); $i < $n; $i++) {
                            ...
                            <tr valign="top">
                                ...
                                <td class="jsvm_left-row">
                                    <a href="<?php echo admin_url('admin.php?page=jsvm_currency&jsvmlt=formcurrency&jsvehiclemanagerid='.$row->id); ?>">
                                        <?php echo __($row->title,'js-vehicle-manager'); ?></a>
                                </td>

                                <td>
                                    <?php if ($row->status == 1) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_currency&task=unpublish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid); ?>">
                                    ...
                                    <?php } else { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_currency&task=publish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid); ?>">
                                ...
                                <td>
                                    ...
                                    <?php } else { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_common&task=makedefault&action=jsvmtask&for=currency&id='.$row->id.$pageid.'&jsvmlt=currencies'); ?>">
                                ...
                                <td>
                                    <?php if ($i != 0 || $pagenum > 1) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_common&task=defaultorderingup&action=jsvmtask&for=currency&id='.$row->id.$pageid.'&jsvmlt=currencies'); ?>">
                                    ...
                                    <?php if ($i < $n - 1 || $islastordershow) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_common&task=defaultorderingdown&action=jsvmtask&for=currency&id='.$row->id.$pageid.'&jsvmlt=currencies'); ?>">
                                ...
                                <td class="jsvm_action">
                                    <a href="<?php echo admin_url('admin.php?page=jsvm_currency&jsvmlt=formcurrency&jsvehiclemanagerid='.$row->id); ?>"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/edit.png" title="<?php echo __('Edit', 'js-vehicle-manager'); ?>"></a>
