...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <div id="jsvehiclemanageradmin-data">
        <div class="jsvm_dashboard">
            ...
            <?php JSVEHICLEMANAGERincluder::getClassesInclude('jsvehiclemanageradminsidemenu'); ?>
            <span class="jsvm_dashboard-icon">
                <?php
                $url = 'http://www.joomsky.com/appsys/latestversion.php?prod=wp-vehicle-manager';
                ...
                if (in_array('curl', get_loaded_extensions())) {
                    ...
                    $result = curl_exec($ch);
                    curl_close($ch);
                    $version = JSVEHICLEMANAGERincluder::getJSModel('configuration')->getConfigurationByConfigName('productversion');
                    if ($version == str_replace('.', '', $result)) {
                        $image = jsvehiclemanager::$_pluginpath . "includes/images/up-dated.png";
                        $lang = __('Your System Is Up To Date', 'js-vehicle-manager');
                        $class = "jsvm_green";
                    } elseif ($result) {
                        $image = jsvehiclemanager::$_pluginpath . "includes/images/new-version.png";
                        $lang = __('New Version Is Available', 'js-vehicle-manager');
                        $class = "jsvm_orange";
                    } else {
                        $image = jsvehiclemanager::$_pluginpath . "includes/images/connection-error.png";
                        $lang = __('Unable Connect To Server', 'js-vehicle-manager');
                        $class = "jsvm_red";
                    }
                } else {
                    $image = jsvehiclemanager::$_pluginpath . "includes/images/connection-error.png";
        ...
        <div id="jsvehiclemanager-admin-wrapper">
            ...
            <div class="jsvm_main-heading">
                <span class="jsvm_text"><?php echo __('Reports and Export', 'js-vehicle-manager'); ?></span>          
            </div>
            <div class="jsvm_box-wrapper">
                <a href="<?php echo admin_url("admin.php?page=jsvm_reports&jsvmlt=overallreports"); ?>" class="jsvm_box">
                    <img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/cp/reports.png" />
                    <div class="jsvm_text">
                        <?php echo __('Reports', 'js-vehicle-manager') ?>
                    </div>
                </a>
            </div>
            <div class="jsvm_main-heading">
            ...
            <div class="jsvm_box-wrapper">
                ...
                <a href="https://www.joomsky.com/support/support-ticket.html" class="jsvm_box">
