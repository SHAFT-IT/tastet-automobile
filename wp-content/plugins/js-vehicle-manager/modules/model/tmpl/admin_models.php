...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <div id="jsvehiclemanageradmin-data">
        ...
        <span class="jsvm_js-admin-title">
            <a href="<?php echo admin_url('admin.php?page=jsvm_make'); ?>"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/back-icon.png" /></a>
            <?php echo jsvehiclemanager::$_data['maketitle']. '\'s '.__('Models', 'js-vehicle-manager'); ?>
            <a class="jsvm_js-button-link button" href="<?php echo admin_url('admin.php?page=jsvm_model&jsvmlt=formmodel&makeid='.jsvehiclemanager::$_data['makeid']); ?>"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add New','js-vehicle-manager') .' '. __('Model','js-vehicle-manager'); ?></a>
        </span>
        ...
        <form class="jsvm_js-filter-form" name="jsvehiclemanagerform" id="jsvehiclemanagerform" method="post" action="<?php echo admin_url("admin.php?page=jsvm_model&makeid=".jsvehiclemanager::$_data['makeid']); ?>">
                        ...
                        for ($i = 0, $n = count(jsvehiclemanager::$_data[0]); $i < $n; $i++) {
                            ...
                            <tr valign="top">
                                ...
                                <td class="jsvm_left-row">
                                    <a href="<?php echo admin_url('admin.php?page=jsvm_model&jsvmlt=formmodel&jsvehiclemanagerid='.$row->id.'&makeid='.jsvehiclemanager::$_data['makeid']); ?>">
                                        <?php echo __($row->title,'js-vehicle-manager'); ?></a>
                                </td>

                                <td>
                                    <?php if ($row->status == 1) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_model&task=unpublish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.'&makeid='.jsvehiclemanager::$_data['makeid'].$pageid); ?>">
                                    ...
                                    <?php } else { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_model&task=publish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.'&makeid='.jsvehiclemanager::$_data['makeid'].$pageid); ?>">
                                ...
                                <td>
                                    <?php if ($i != 0 || $pagenum > 1) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_common&task=defaultorderingup&action=jsvmtask&for=model&id='.$row->id.'&makeid='.jsvehiclemanager::$_data['makeid'].$pageid.'&jsvmlt=models'); ?>">
                                    ...
                                    <?php if ($i < $n - 1 || $islastordershow) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_common&task=defaultorderingdown&action=jsvmtask&for=model&id='.$row->id.'&makeid='.jsvehiclemanager::$_data['makeid'].$pageid.'&jsvmlt=models'); ?>">
                                ...
                                <td class="jsvm_action">
                                    <a href="<?php echo admin_url('admin.php?page=jsvm_model&jsvmlt=formmodel&jsvehiclemanagerid='.$row->id.'&makeid='.jsvehiclemanager::$_data['makeid']); ?>"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/edit.png" title="<?php echo __('Edit', 'js-vehicle-manager'); ?>"></a>
                                    <a href="<?php echo admin_url('admin.php?page=jsvm_model&task=remove&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.'&makeid='.jsvehiclemanager::$_data['makeid']); ?>" onclick="return confirmdelete('<?php echo __('Are you sure to delete', 'js-vehicle-manager').' ?'; ?>');"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/remove.png" title="<?php echo __('Delete', 'js-vehicle-manager'); ?>"></a>
                                </td>
                            </tr>
                    <?php
                        }
