...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <span class="jsvm_js-admin-title">
        <a href="<?php echo admin_url('admin.php?page=jsvm_model&makeid='.jsvehiclemanager::$_data['makeid']); ?>"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/back-icon.png" /></a>
    ...
    <div class="jsvehiclemanager-form-wrap">
        <form id="jsvehiclemanager-form" method="post" action="<?php echo admin_url("admin.php?page=jsvm_model&task=savemodel"); ?>">
            ...
            <div class="jsvm_js-submit-container">
                <div class="jsvm_js-button-container">
                    <a id="jsvm_form-cancel-button" href="<?php echo admin_url('admin.php?page=jsvm_model&makeid='.jsvehiclemanager::$_data['makeid']); ?>" ><?php echo __('Cancel', 'js-vehicle-manager'); ?></a>
                    <?php echo JSVEHICLEMANAGERformfield::submitbutton('save', __('Save','js-vehicle-manager') .' '. __('Model', 'js-vehicle-manager'), array('class' => 'button')); ?>
                </div>
            </div>
        </form>
    </div>
