...
function showLightBox(vehid){
    ...
    jQuery.post(ajaxurl, {action: 'jsvehiclemanager_ajax', jsvmme: 'vehicle', task: 'getVehicleImagesByVehicleidAJAX', vehicleid: vehid}, function(data){
        if (data){
...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <div id="jsvehiclemanageradmin-data">
        ...
        <span class="jsvm_js-admin-title">
            ...
            <?php echo __(' Vehicle', 'js-vehicle-manager'); ?>
            </a>
            <?php JSVEHICLEMANAGERincluder::getClassesInclude('jsvehiclemanageradminsidemenu'); ?>
                        ...
                        <div id="jsvehiclemanager_vehicle_wrapper">
                            ...
                            <div id="jsvehiclemanager_vehicle_bottom_wrap">
                                ...
                                <div id="jsvehiclemanager_vehicle_right_button">
                                    ...
                                    <a id="jsvehiclemanager_vehicle_btn" href="<?php echo admin_url('admin.php?page=jsvm_vehicle&task=remove&action=jsvmtask&jsvehiclemanager-cb[]='.$row->vehicleid); ?>" onclick="return confirmdelete('<?php echo __('Are you sure to delete', 'js-vehicle-manager').' ?'; ?>');">
