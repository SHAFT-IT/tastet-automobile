        ...
        <?php
            if (!empty(jsvehiclemanager::$_data[0])) {
                    ...
                    for ($i = 0, $n = count(jsvehiclemanager::$_data[0]); $i < $n; $i++) {
                        ...
                        $featuredexpiry = date_i18n('Y-m-d', strtotime($vehicle->endfeatureddate));
                        ?> 
                        <div class="jsvehiclemanager_vehicle_wrapper">
                            <div class="jsvehiclemanager_vehicle_top_wrap">
                                ...
                                <div class="jsvehiclemanager_vehicle_right_content">
                                    ...
                                    <div class="jsvehiclemanager_vehicle_detail_row">
                                        <span class="jsvehiclemanager_vehicle_loction_title"><?php echo __('Expiry Date','js-vehicle-manager').':&nbsp;'; ?></span>
                                        <span class="jsvehiclemanager_vehicle_location_value">
                                            <?php echo date_i18n(jsvehiclemanager::$_config['date_format'],strtotime($vehicle->adexpiryvalue)); ?>
                                        </span>
                                    </div>
                                    <?php 
                            ...
                            <div class="jsvehiclemanager_vehicle_bottom_wrap" class="jsvehiclemanager_frontend">
                                ...
                                <div class="jsvehiclemanager_vehicle_right_button">
                                    ...
                                    <a class="jsvehiclemanager_vehicle_btn" href="<?php echo jsvehiclemanager::makeUrl(array('jsvmme'=>'vehicle','action'=>'jsvmtask','task'=>'removevehicle','jsvehiclemanagerid'=>$vehicle->vehicleid,'jsvehiclemanagerpageid'=>jsvehiclemanager::getPageid())); ?>" onclick="return confirm('<?php echo __('Are you sure to delete?','js-vehicle-manager'); ?>');">
