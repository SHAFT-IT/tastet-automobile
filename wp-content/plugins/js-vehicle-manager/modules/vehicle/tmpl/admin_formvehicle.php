...
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        ...
        jQuery("a#jsvm_userpopup").click(function (e) {
            ...
            jsvm_showloading();
            jQuery.post(ajaxurl, {action: 'jsvehiclemanager_ajax', jsvmme: 'user', task: 'getSellerListAjax'}, function (data) {
                if (data) {
        ...
        jQuery(document).delegate('form#jsvm_userpopupsearch', 'submit', function (e) {
            ...
            var ajaxurl = "<?php echo admin_url('admin-ajax.php') ?>";
            jQuery.post(ajaxurl, {action: 'jsvehiclemanager_ajax', jsvmme: 'user', task: 'getSellerListAjax', name: name, uname: username, email: emailaddress, listfor: 1}, function (data) {
                if (data) {
                    jQuery("span#jsvm_popup_title").html(jQuery("input#jsvm_user-popup-title-text").val());
                    jQuery("div#jsvm_popup-record-data").html(data);
                    setUserLink();
    ...
    function updateuserlist(pagenum) {
        var ajaxurl = "<?php echo admin_url('admin-ajax.php') ?>";
        jQuery.post(ajaxurl, {action: 'jsvehiclemanager_ajax', jsvmme: 'user', task: 'getSellerListAjax', userlimit: pagenum}, function (data) {
            if (data) {
                jQuery("div#jsvm_popup-record-data").html("");
                jQuery("span#jsvm_popup_title").html(jQuery("input#jsvm_user-popup-title-text").val());
                jQuery("div#jsvm_popup-record-data").html(data);
            ...
            <form  method="post" name="adminForm" id="jsvm_adminForm" class="jsvm_form-validate js-form-horizontal" enctype="multipart/form-data" action="<?php echo admin_url("admin.php?page=jsvm_vehicle&action=jsvmtask&task=savevehicle"); ?>">
                ...
                <div class="jsvm_js-buttons-area">
                    <div class="jsvm_js-buttons-area-btn">
                        <a class="jsvm_js-btn-cancel" href="?page=jsvm_vehicle"><?php echo __('Cancel'); ?></a>
        ...
        jQuery("#loccity").tokenInput(vehicleArray, {
            ...
            onAdd: function(item) {
                ...
                if ($newtyped_cities == 1) { ?>
                    ...
                    var ajaxurl = "<?php echo admin_url('admin-ajax.php') ?>";
                            jQuery.post(ajaxurl, {action: 'jsvehiclemanager_ajax', jsvmme: 'city', task: 'savetokeninputcity', citydata: jQuery("tester").text()}, function(data){
                            if (data){
                            try {
