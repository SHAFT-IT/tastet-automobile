                            ...
                            <div id="jsvehiclemanager_vehicle_bottom_wrap">
                                ...
                                <div id="jsvehiclemanager_vehicle_right_button">
                                    <div id="jsvehiclemanager_vehicle_button_area">
                                                <a id="jsvehiclemanager_vehicle_btn" href="<?php echo admin_url('admin.php?page=jsvm_vehicle&task=approvequeuevehicle&action=jsvmtask&id='.$row->vehicleid.$pageid.'&jsvmlt=vehiclequeue'); ?>">
                                                ...
                                                <a id="jsvehiclemanager_vehicle_btn" href="<?php echo admin_url('admin.php?page=jsvm_vehicle&task=rejectqueuevehicle&action=jsvmtask&id='.$row->vehicleid.$pageid.'&jsvmlt=vehiclequeue'); ?>">
                                        ...
                                        <a id="jsvehiclemanager_vehicle_btn" href="<?php echo admin_url('admin.php?page=jsvm_vehicle&task=remove&action=jsvmtask&fromqueue=1&jsvehiclemanager-cb[]='.$row->vehicleid); ?>" onclick="return confirmdelete('<?php echo __('Are you sure to delete', 'js-vehicle-manager').' ?'; ?>');">
...
<script type="text/javascript">
    function getmodels(src, val){
        ...
        var ajaxurl = "<?php echo admin_url('admin-ajax.php') ?>";
            jQuery.post(ajaxurl, {action: 'jsvehiclemanager_ajax', jsvmme: 'model', task: 'getVehiclesModelsbyMake', makeid: val}, function(data){
                if (data){
