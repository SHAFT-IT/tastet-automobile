                            ...
                            <tr>
                                ...
                                <td width="20%">
                                    <?php if ($row->enabled == '1') { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_city&task=unpublish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid); ?>">
                                            <img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/yes.png" alt="Default" border="0" />
                                        </a>
                                    <?php } else { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_city&task=publish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid); ?>">
