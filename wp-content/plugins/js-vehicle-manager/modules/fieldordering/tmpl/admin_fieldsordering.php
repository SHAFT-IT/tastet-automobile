...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <div id="jsvehiclemanageradmin-data">
        ...
        <div class="jsvm_page-actions js-row no-margin ">
            <a class="jsvm_js-bulk-link button jsvm_multioperation" message="<?php echo JSVEHICLEMANAGERmessages::getMSelectionEMessage(); ?>" data-for="fieldpublished" href="#"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/user-publish.png" /><?php echo __('User Publish', 'js-vehicle-manager') ?></a>
            <a class="jsvm_js-bulk-link button jsvm_multioperation" message="<?php echo JSVEHICLEMANAGERmessages::getMSelectionEMessage(); ?>" data-for="fieldunpublished" href="#"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/user-unpublish.png" /><?php echo __('User Unpublished', 'js-vehicle-manager') ?></a>
            <a class="jsvm_js-bulk-link button jsvm_multioperation" message="<?php echo JSVEHICLEMANAGERmessages::getMSelectionEMessage(); ?>" data-for="visitorfieldpublished" href="#"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/publish-icon.png" /><?php echo __('Visitor Publish', 'js-vehicle-manager') ?></a>
            <a class="jsvm_js-bulk-link button jsvm_multioperation" message="<?php echo JSVEHICLEMANAGERmessages::getMSelectionEMessage(); ?>" data-for="visitorfieldunpublished" href="#"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/unbuplish.png" /><?php echo __('Visitor Unpublished', 'js-vehicle-manager') ?></a>
            <a class="jsvm_js-bulk-link button jsvm_multioperation" message="<?php echo JSVEHICLEMANAGERmessages::getMSelectionEMessage(); ?>" data-for="fieldrequired" href="#"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/yes.png" /><?php echo __('Required', 'js-vehicle-manager') ?></a>
            <a class="jsvm_js-bulk-link button jsvm_multioperation" message="<?php echo JSVEHICLEMANAGERmessages::getMSelectionEMessage(); ?>" data-for="fieldnotrequired" href="#"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/no.png" /><?php echo __('Not Required', 'js-vehicle-manager') ?></a>
        </div>
        ...
        <script type="text/javascript">
            ...
            function showPopupAndSetValues(id) {
                ...
                jQuery.post(ajaxurl, {action: 'jsvehiclemanager_ajax', jsvmme: 'fieldordering', task: 'getOptionsForFieldEdit', field: id}, function (data) {
                    if (data) {
                                ...
                                if ($sec == 'section_') {
                                    ...
                                    <td>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                            <a href="<?php echo admin_url('admin.php?page=jsvm_fieldordering&task='.$task.'&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid.'&ff='.jsvehiclemanager::$_data['fieldfor']); ?>">
                        ...
                        <?php } else { ?>
                                    ...
                                    <td>
                                           ...
                                           if ($row->ordering != 1) {
                                               if ($newsection != 1) {
                                                   ?>
                                                <a href="<?php echo admin_url('admin.php?page=jsvm_fieldordering&task=fieldorderingup&action=jsvmtask&fieldid='.$row->id.$pageid.'&ff='.jsvehiclemanager::$_data['fieldfor']); ?>">
                                        ...
                                        if ($row->section == $row1->section) {
                                            ?>
                                            <a href="<?php echo admin_url('admin.php?page=jsvm_fieldordering&task=fieldorderingdown&action=jsvmtask&fieldid='.$row->id.$pageid.'&ff='.jsvehiclemanager::$_data['fieldfor']); ?>">
