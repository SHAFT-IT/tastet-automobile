...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <div id="jsvehiclemanageradmin-data">
        ...
        <div class="jsvm_page-actions">
            <a class="js-bulk-link button jsvm_multioperation" message="<?php echo JSVEHICLEMANAGERmessages::getMSelectionEMessage(); ?>" data-for="publish" href="#"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/publish-icon.png" /><?php echo __('Publish', 'js-vehicle-manager') ?></a>
            <a class="js-bulk-link button jsvm_multioperation" message="<?php echo JSVEHICLEMANAGERmessages::getMSelectionEMessage(); ?>" data-for="unpublish" href="#"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/unbuplish.png" /><?php echo __('Unpublished', 'js-vehicle-manager') ?></a>
        ...
        if (!empty(jsvehiclemanager::$_data[0])) {
            ...
            <form id="jsvehiclemanager-list-form" method="post" action="<?php echo admin_url("admin.php?page=jsvm_adexpiry"); ?>">
                <table id="jsvm_js-table">
                    <thead>
                        <tr>
                            <th class="jsvm_grid"><input type="checkbox" name="selectall" id="selectall" value=""></th>
                        ...
                        for ($i = 0, $n = count(jsvehiclemanager::$_data[0]); $i < $n; $i++) {
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    ...
                                    <?php } else { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_common&task=makedefault&action=jsvmtask&for=adexpiry&id='.$row->id.$pageid.'&jsvmlt=adexpiries'); ?>">
                                ...
                                <td>
                                    <?php if ($row->status == 1) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_adexpiry&task=unpublish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid); ?>">
                                    ...
                                    <?php } else { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_adexpiry&task=publish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid); ?>">
                                ...
                                <td>
                                    <?php if ($i != 0 || $pagenum > 1) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_common&task=defaultorderingup&action=jsvmtask&for=adexpiry&id='.$row->id.$pageid.'&jsvmlt=adexpiries'); ?>">
                                    ...
                                    <?php if ($i < $n - 1 || $islastordershow) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_common&task=defaultorderingdown&action=jsvmtask&for=adexpiry&id='.$row->id.$pageid.'&jsvmlt=adexpiries'); ?>">
