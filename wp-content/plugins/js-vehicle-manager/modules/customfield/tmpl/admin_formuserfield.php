...
<div id="jsjobsadmin-wrapper">
    ...
    <div id="jsvehiclemanageradmin-data">
        ...
        ?>
        <form id="jsjobs-form" method="post" action="<?php echo admin_url("admin.php?page=jsvm_fieldordering&task=saveuserfield"); ?>">
                ...
                <table id="js-table">
                    ...
                    <tbody id="fieldValuesBody">
                        ...
                        if (isset(jsvehiclemanager::$_data[0]['userfield']->type) && jsvehiclemanager::$_data[0]['userfield']->type == 'select') {
                            ...
                            <td width="10%"><a href="javascript:void(0);" data-rowid="jsjobs_trcust<?php echo $i; ?>" data-optionid="<?php echo $value->id; ?>"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/remove.png"></a></td>
                            </tr>
                            <?php
                            $i++;
                        }
                        ...
                        <tr id="jsjobs_trcust0">
                            ...
                            <td width="10%"><a data-rowid="jsjobs_trcust0" href="javascript:void(0);"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/remove.png"></a></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                </table>
        ...
        <script type="text/javascript">
            ...
            function comboOfFields() {
                ...
                jQuery.post(ajaxurl, {action: 'jsvehiclemanager_ajax', jsvmme: 'fieldordering', task: 'getFieldsForComboByFieldFor', fieldfor: ff}, function (data) {
                    if (data) {
            ...
            function getDataOfSelectedField() {
                ...
                jQuery.post(ajaxurl, {action: 'jsvehiclemanager_ajax', jsvmme: 'fieldordering', task: 'getSectionToFillValues', pfield: field}, function (data) {
                    if (data) {
                        var d = jQuery.parseJSON(data);
