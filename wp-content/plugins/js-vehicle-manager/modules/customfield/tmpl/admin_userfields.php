...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <div id="jsvehiclemanageradmin-data">
        ...
        <form class="jsvm_js-filter-form" name="jsjobsform" id="jsvehiclemanagerform" method="post" action="<?php echo admin_url("admin.php?page=jsvm_customfield&ff=" . jsvehiclemanager::$_data['fieldfor']); ?>">
            ...
            <?php echo JSVEHICLEMANAGERformfield::hidden('JSJOBS_form_search', 'JSJOBS_SEARCH'); ?>
        ...
        if (!empty(jsvehiclemanager::$_data[0])) {
            ...
            <form id="jsvehiclemanager-list-form" method="post" action="<?php echo admin_url("admin.php?page=jsvm_customfield"); ?>">
                        ...
                        for ($i = 0, $n = count(jsvehiclemanager::$_data[0]); $i < $n; $i++) {
                            ...
                            <tr valign="top">
                                <td class="jsvm_grid-rows">
                                    <input type="checkbox" class="jsvm_jsjobs-cb" id="jsvehiclemanager-cb" name="jsjobs-cb[]" value="<?php echo $row->id; ?>" />
                                </td>
                                <td class="jsvm_left-row"><a href="<?php echo admin_url('admin.php?page=jsvm_customfield&jsvmlt=formuserfield&jsjobsid='.$row->id); ?>"><?php echo $row->name; ?></a></td>
                                ...
                                <td class="jsvm_action">
                                    <a href="<?php echo admin_url('admin.php?page=jsvm_customfield&jsvmlt=formuserfield&jsjobsid='.$row->id); ?>"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/edit.png" title="<?php echo __('Edit', 'js-vehicle-manager'); ?>"></a>
                                    <a href="<?php echo admin_url('admin.php?page=jsvm_customfield&task=remove&action=jsvmtask&jsjobs-cb[]='.$row->id); ?>" onclick="return confirmdelete('<?php echo __('Are you sure to delete', 'js-vehicle-manager').' ?'; ?>');"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/remove.png" title="<?php echo __('Delete', 'js-vehicle-manager'); ?>"></a>
                                </td>
                            </tr>
                            <?php
                            $k = 1 - $k;
                ...
                <?php echo JSVEHICLEMANAGERformfield::hidden('form_request', 'jsjobs'); ?>
            </form>
            <?php
