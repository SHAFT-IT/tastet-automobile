                    ...
                    <tbody>
                        ...
                        for ($i = 0, $n = count(jsvehiclemanager::$_data[0]); $i < $n; $i++) {
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <?php if ($row->status == 1) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_make&task=unpublish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid); ?>">
                                    ...
                                    <?php } else { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_make&task=publish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid); ?>">
                                ...
                                <td>
                                    <?php if ($i != 0 || $pagenum > 1) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_common&task=defaultorderingup&action=jsvmtask&for=make&id='.$row->id.$pageid.'&jsvmlt=makes'); ?>">
                                    ...
                                    <?php if ($i < $n - 1 || $islastordershow) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_common&task=defaultorderingdown&action=jsvmtask&for=make&id='.$row->id.$pageid.'&jsvmlt=makes'); ?>">
