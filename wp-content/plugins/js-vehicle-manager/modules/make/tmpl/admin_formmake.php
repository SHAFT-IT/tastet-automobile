...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <div id="jsvehiclemanageradmin-data">
        <span class="jsvm_js-admin-title">
            ...
            <?php echo $msg . ' ' . __('Make', 'js-vehicle-manager'); ?>
            <?php JSVEHICLEMANAGERincluder::getClassesInclude('jsvehiclemanageradminsidemenu'); ?>
        </span>
        <div class="jsvehiclemanager-form-wrap">
            <form id="jsvehiclemanager-form" method="post" enctype="multipart/form-data" action="<?php echo admin_url("admin.php?page=jsvm_make&task=savemake"); ?>">
                     ...
                     if(isset(jsvehiclemanager::$_data[0]->logo) AND !empty(jsvehiclemanager::$_data[0]->logo)){ 
                        ...
                        <div class="jsvm_js-logo-wrap">
                            <div class="jsvm_js-logo-img"> 
                                <img id="jsvm_js-logoimg" src="<?php echo $imgpath; ?>" />
                ...
                <div class="jsvm_js-submit-container">
                    <div class="jsvm_js-button-container">    
                        <a id="jsvm_form-cancel-button" href="<?php echo admin_url('admin.php?page=jsvm_make'); ?>" ><?php echo __('Cancel', 'js-vehicle-manager'); ?></a>
                        <?php echo JSVEHICLEMANAGERformfield::submitbutton('save', __('Save','js-vehicle-manager') .' '. __('Make', 'js-vehicle-manager'), array('class' => 'button')); ?>
                    </div>
                </div>
            </form>
        </div>
