...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <div id="jsvehiclemanageradmin-data">
        ...
        <span class="jsvm_js-admin-title">
            ...
            <?php JSVEHICLEMANAGERincluder::getClassesInclude('jsvehiclemanageradminsidemenu'); ?>
            <a class="jsvm_js-button-link button" href="<?php echo admin_url('admin.php?page=jsvm_transmissions&jsvmlt=formtransmission'); ?>"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add New','js-vehicle-manager') .' '. __('Transmission','js-vehicle-manager'); ?></a>
        </span>
        <div class="jsvm_page-actions">
            <a class="jsvm_js-bulk-link button jsvm_multioperation" message="<?php echo JSVEHICLEMANAGERmessages::getMSelectionEMessage(); ?>" data-for="publish" href="#"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/publish-icon.png" /><?php echo __('Publish', 'js-vehicle-manager') ?></a>
            <a class="jsvm_js-bulk-link button jsvm_multioperation" message="<?php echo JSVEHICLEMANAGERmessages::getMSelectionEMessage(); ?>" data-for="unpublish" href="#"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/unbuplish.png" /><?php echo __('Unpublished', 'js-vehicle-manager') ?></a>
        ...
        <form class="jsvm_js-filter-form" name="jsvehiclemanagerform" id="jsvehiclemanagerform" method="post" action="<?php echo admin_url("admin.php?page=jsvm_transmissions"); ?>">
            ...
            <?php echo JSVEHICLEMANAGERformfield::select('status', JSVEHICLEMANAGERincluder::getJSModel('common')->getstatus(), jsvehiclemanager::$_data['filter']['status'], __('Select status', 'js-vehicle-manager'), array('class' => 'jsvm_inputbox')); ?>
        ...
        if (!empty(jsvehiclemanager::$_data[0])) {
            ?>
            <form id="jsvehiclemanager-list-form" method="post" action="<?php echo admin_url("admin.php?page=jsvm_transmissions"); ?>">
                        ...
                        for ($i = 0, $n = count(jsvehiclemanager::$_data[0]); $i < $n; $i++) {
                            ...
                            <tr valign="top">
                                ...
                                <td class="jsvm_left-row">
                                    <a href="<?php echo admin_url('admin.php?page=jsvm_transmissions&jsvmlt=formtransmission&jsvehiclemanagerid='.$row->id); ?>">
                                        <?php echo __($row->title,'js-vehicle-manager'); ?></a>
                                </td>

                                <td>
                                    <?php if ($row->status == 1) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_transmissions&task=unpublish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid); ?>">
                                    ...
                                    <?php } else { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_transmissions&task=publish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid); ?>">
                                ...
                                <td>
                                    ...
                                    <?php } else { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_common&task=makedefault&action=jsvmtask&for=transmissions&id='.$row->id.$pageid.'&jsvmlt=transmissions'); ?>">
                                ...
                                <td>
                                    <?php if ($i != 0 || $pagenum > 1) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_common&task=defaultorderingup&action=jsvmtask&for=transmissions&id='.$row->id.$pageid.'&jsvmlt=transmissions'); ?>">
                                    ...
                                    <?php if ($i < $n - 1 || $islastordershow) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_common&task=defaultorderingdown&action=jsvmtask&for=transmissions&id='.$row->id.$pageid.'&jsvmlt=transmissions'); ?>">
                                ...
                                <td class="jsvm_action">
                                    <a href="<?php echo admin_url('admin.php?page=jsvm_transmissions&jsvmlt=formtransmission&jsvehiclemanagerid='.$row->id); ?>"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/edit.png" title="<?php echo __('Edit', 'js-vehicle-manager'); ?>"></a>
                                    <a href="<?php echo admin_url('admin.php?page=jsvm_transmissions&task=remove&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id); ?>" onclick="return confirmdelete('<?php echo __('Are you sure to delete', 'js-vehicle-manager').' ?'; ?>');"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/remove.png" title="<?php echo __('Delete', 'js-vehicle-manager'); ?>"></a>
                                </td>
                            </tr>
                    <?php
                        }
