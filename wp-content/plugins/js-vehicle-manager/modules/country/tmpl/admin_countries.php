                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($row->enabled == 1) { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_country&task=unpublish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid); ?>">
                                            <img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/yes.png" alt="<?php echo __('Published', 'js-vehicle-manager'); ?>" />
                                        </a>
                                    <?php } else { ?>
                                        <a href="<?php echo admin_url('admin.php?page=jsvm_country&task=publish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.$pageid); ?>">
