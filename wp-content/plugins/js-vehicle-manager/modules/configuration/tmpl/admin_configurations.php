                ...
                <div class="jsvm_tabInner">
                    <div id="jsvm_site_setting">
                        ...
                        <div class="jsvm_js-vehicle-manager-configuration-table">
                            <div class="jsvm_left">
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Auto assign package to new user', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Auto approve free package', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Purchase free package only once', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            ...
                            <div class="jsvm_right">
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('User register redirect', 'js-vehicle-manager'); ?></div>
                                    ...
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-description"><small><?php echo __('New user register redirect page', 'js-vehicle-manager'); ?></small></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="jsvm_vehicle_setting">
                        ...
                        <div class="js-vehicle-manager-configuration-table">
                            <div class="jsvm_left">
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Visitor can add vehicle', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            ...
                            <div class="jsvm_right">
                                ...
                                */ ?>
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Visitor add vehicle redirect page', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                        ...
                        <div class="js-vehicle-manager-configuration-table">
                            <div class="jsvm_left">
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Show sold vehicles', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Show featured vehicles', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Limit vehicle alerts', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Vehicle alert action button', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Vehicle alert popup delay', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Featured vehicle auto approve', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Number of featured vehicles', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                     ...
                     <div id="jsvm_vehicle_detail">
                        ...
                        <div class="js-vehicle-manager-configuration-table">
                            <div class="jsvm_left">
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Shortlist', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Tell A Friend', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Make An Offer', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Schedule Test Drive', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            ...
                            <div class="jsvm_right">
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('PDF', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Print', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Seller Detail', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                    ...
                    <div id="jsvm_adsense">
                        ...
                        <div class="js-vehicle-manager-configuration-table">
                            <div class="jsvm_left">
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Show google adds in list vehicle', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Google adsense client id', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Google adsense slot id', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Google adds show after number of vehicles', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            ...
                            <div class="jsvm_right">
                                 <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Google adds width', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Google adds height', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Google adds custom css', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                    ...
                    <div id="jsvm_rss">
                        ...
                        <div class="js-vehicle-manager-configuration-table">
                            <div class="jsvm_left">
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Vehicle RSS', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Title', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Description', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Copyright', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Show vehicle image', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            ...
                            <div class="jsvm_right">
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Editor', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Time to live', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Web master', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Show Vehicle Condition', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                    ...
                    <div id="jsvm_sociallogin">
                        ...
                        <div class="js-vehicle-manager-configuration-table">
                            <div class="jsvm_left">
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Login with facebook', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('API Key', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            ...
                            <div class="jsvm_right">
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Secret', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                        ...
                        <div class="js-vehicle-manager-configuration-table">
                            <div class="jsvm_left">
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Login with linkedin', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                        ...
                        <h3 class="js-vehicle-manager-configuration-heading-main"><?php echo __('Xing', 'js-vehicle-manager'); ?></h3>
                        <div class="js-vehicle-manager-configuration-table">
                            <div class="jsvm_left">
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Login with Xing', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-value"><?php echo JSVEHICLEMANAGERformfield::select('loginwithxing', $yesno, jsvehiclemanager::$_data[0]['loginwithxing']); ?><div><small></small></div></div>
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-description"><small><?php echo __('Xing user can login in js vehicle manager', 'js-vehicle-manager'); echo '<br/>'; ?></small></div>
                                </div>
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('API Key', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-value"><?php echo JSVEHICLEMANAGERformfield::text('apikeyxing', jsvehiclemanager::$_data[0]['apikeyxing'], array('class' => 'jsvm_inputbox')); ?></div>
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-description"><small><?php echo __('API key is required for xing app', 'js-vehicle-manager');  ?></small></div>
                                </div>
                            </div>
                            <div class="jsvm_right">
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Secret', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-value"><?php echo JSVEHICLEMANAGERformfield::text('clientsecretxing', jsvehiclemanager::$_data[0]['clientsecretxing'], array('class' => 'jsvm_inputbox')); ?></div>
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-description"><small></small></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="jsvm_socailsharing">
                        <h3 class="js-vehicle-manager-configuration-heading-main"><?php echo __('Social Media', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></h3>
                        <div class="js-vehicle-manager-configuration-table">
                            <div class="js-vehicle-managerconfig-threecols">
                                <div class="js-vehicle-manager-configuration-row"><label><?php echo JSVEHICLEMANAGERformfield::checkbox('tumbler_share', $social, (jsvehiclemanager::$_data[0]['tumbler_share'] == 1) ? 1 : 0, array('class' => 'jsvm_checkbox')); ?><?php echo __('Tumbler share', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            </div>
                            <?php /*
                            <div class="js-vehicle-managerconfig-threecols">
                            ...
                            */ ?>
                            <div class="js-vehicle-managerconfig-threecols">
                                <div class="js-vehicle-manager-configuration-row"><label><?php echo JSVEHICLEMANAGERformfield::checkbox('fb_share', $social, (jsvehiclemanager::$_data[0]['fb_share'] == 1) ? 1 : 0, array('class' => 'jsvm_checkbox')); ?><?php echo __('Facebook share', 'js-vehicle-manager'); ?></label><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            </div>
                            <div class="js-vehicle-managerconfig-threecols">
                                <div class="js-vehicle-manager-configuration-row"><label><?php echo JSVEHICLEMANAGERformfield::checkbox('google_share', $social, (jsvehiclemanager::$_data[0]['google_share'] == 1) ? 1 : 0, array('class' => 'jsvm_checkbox')); ?><?php echo __('Google share', 'js-vehicle-manager'); ?></label><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            </div>
                            <div class="js-vehicle-managerconfig-threecols">
                                <div class="js-vehicle-manager-configuration-row"><label><?php echo JSVEHICLEMANAGERformfield::checkbox('blogger_share', $social, (jsvehiclemanager::$_data[0]['blogger_share'] == 1) ? 1 : 0, array('class' => 'jsvm_checkbox')); ?><?php echo __('Blogger share', 'js-vehicle-manager'); ?></label><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            </div>
                            <div class="js-vehicle-managerconfig-threecols">
                                <div class="js-vehicle-manager-configuration-row"><label><?php echo JSVEHICLEMANAGERformfield::checkbox('instgram_share', $social, (jsvehiclemanager::$_data[0]['instgram_share'] == 1) ? 1 : 0, array('class' => 'jsvm_checkbox')); ?><?php echo __('Instagram share', 'js-vehicle-manager'); ?></label><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            </div>
                            <div class="js-vehicle-managerconfig-threecols">
                                <div class="js-vehicle-manager-configuration-row"><label><?php echo JSVEHICLEMANAGERformfield::checkbox('linkedin', $social, (jsvehiclemanager::$_data[0]['linkedin'] == 1) ? 1 : 0, array('class' => 'jsvm_checkbox')); ?><?php echo __('Linkedin share', 'js-vehicle-manager'); ?></label><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            </div>
                            <div class="js-vehicle-managerconfig-threecols">
                                <div class="js-vehicle-manager-configuration-row"><label><?php echo JSVEHICLEMANAGERformfield::checkbox('digg_share', $social, (jsvehiclemanager::$_data[0]['digg_share'] == 1) ? 1 : 0, array('class' => 'jsvm_checkbox')); ?><?php echo __('Digg share', 'js-vehicle-manager'); ?></label><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            </div>
                            <div class="js-vehicle-managerconfig-threecols">
                                <div class="js-vehicle-manager-configuration-row"><label><?php echo JSVEHICLEMANAGERformfield::checkbox('twitter_share', $social, (jsvehiclemanager::$_data[0]['twitter_share'] == 1) ? 1 : 0, array('class' => 'jsvm_checkbox')); ?><?php echo __('Twitter share', 'js-vehicle-manager'); ?></label><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            </div>
                            <div class="js-vehicle-managerconfig-threecols">
                                <div class="js-vehicle-manager-configuration-row"><label><?php echo JSVEHICLEMANAGERformfield::checkbox('pintrest_share', $social, (jsvehiclemanager::$_data[0]['pintrest_share'] == 1) ? 1 : 0, array('class' => 'jsvm_checkbox')); ?><?php echo __('Pintrest share', 'js-vehicle-manager'); ?></label><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            </div>
                        </div>
                    </div>
                   ...
                   <div id="jsvm_memberlinks">
                        <h3 class="js-vehicle-manager-configuration-heading-main"><?php echo __('User Top Menu Links', 'js-vehicle-manager'); ?></h3>
                         <div class="js-vehicle-manager-configuration-table">
                            <div class="jsvm_left">
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Shortlist Vehicles', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                        ...
                        <div class="js-vehicle-manager-configuration-table">
                            <div class="jsvm_left">
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Compare', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                            ...
                            <div class="jsvm_right">
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Packages', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Rate List', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Credits Log', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Purchase History', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Stats', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Vehicle Alert', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                    ...
                    <!--Visitor Links End-->
                        <div id="jsvm_seller">
                         <div class="js-vehicle-manager-configuration-table">
                            <div class="jsvm_left">
                              <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Buyer Can Contact Seller', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                    ...
                    <div id="jsvm_recaptcha">
                        <h3 class="js-vehicle-manager-configuration-heading-main"><?php echo __('Recaptcha', 'js-vehicle-manager'); ?></h3>
                         ...
                         <div class="js-vehicle-manager-configuration-table">
                            ...
                            <div class="jsvm_right">
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Contact To Seller', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
                                ...
                                <div class="js-col-xs-12 js-col-md-12 js-vehicle-manager-configuration-row">
                                    <div class="js-col-xs-12  js-vehicle-manager-configuration-title"><?php echo __('Vehicle Form', 'js-vehicle-manager'); ?><font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font></div>
