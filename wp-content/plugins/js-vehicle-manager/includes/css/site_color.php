...
<style type="text/css">
    ...
    /*Buyer Cp Front-End*/
    div#jsvehiclemanager-wrapper div.jsvm_control-pannel-header {border-color:#00a9e0;}
...
div#jsvehiclemanager-wrapper div#jsvehiclemanager-buyer-cp div.jsvehiclemanager-stats-wrapper div.jsvehiclemanager_cpcontent div.jsvehiclemanager-stats-detail-wrapper div.jsvehiclemanager-stats-detail-bottom div.jsvehiclemanager-stats-detail-text{color:#757575;}
    ...
    /* Vehicle List */
    div#jsvehiclemanageradmin-wrapper div#jsvehiclemanageradmin-data div#jsvm_jsjobs-header-main-wrapper{background-color: <?php echo $color1;?>; border-bottom-color:<?php echo $color1;?>;}
    ...
    div#jsvehiclemanager-wrapper div#jsvehiclemanager-compare-vehicle-wrapper div.jsvehiclemanager_cm-compare-wrapper div.jsvehiclemanager_cm-veh-comp-data div.jsvehiclemanager-compare-vehicle-fields div.jsvehiclemanager-compare-vehicle-fields-section span.jsvehiclemanager_cm-com-veh-name{color:<?php echo $color6; ?>;border-bottom:1px solid <?php echo $color5; ?>;background:<?php echo $color7; ?>;}
    div#jsvehiclemanager-wrapper div#jsvehiclemanager-compare-vehicle-wrapper div.jsvehiclemanager_cm-compare-wrapper div.jsvehiclemanager_cm-veh-comp-data div.jsvehiclemanager-compare-vehicle-fields div.jsvehiclemanager-compare-vehicle-fields-section span.jsvehiclemanager_cm-com-veh-txt{color:<?php echo $color6; ?>;border-bottom:1px solid <?php echo $color5; ?>;background:<?php echo $color7; ?>;}
    ...
    table#jsvehiclemanager-table tbody.stats tr td{border:1px solid <?php echo $color5; ?>; color: <?php echo $color4; ?>; background: #ffffff;}
